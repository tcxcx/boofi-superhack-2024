        ...
        <div className="relative flex flex-col items-center justify-center w-full ">
          <div className="relative z-10 text-center bg-background dark:bg-background rounded-lg shadow-lg p-8 max-w-md w-full border-2 border-black dark:border-white">
            ...
            <p className="text-lg mb-8">
              {translations.to}
              <br />
              <span className="inline-block bg-gradient-to-r text-7xl from-indigo-300 via-purple-400 to-cyan-300 bg-clip-text text-transparent">
                BooFi
              </span>
            </p>
            {renderSlogan()}
            <p className="text-lg mb-8">
              Please connect your wallet to view the content.
            </p>
          </div>
        </div>
      </div>
