export const currencyAddresses: Record<number, Record<string, string>> = {
  1: {
    // Ethereum Mainnet
  ...
  919: {
    // Mode Testnet
    DAI: "0x9e5AAC1Ba1a2e6aEd6b32689DFcF62A509Ca96f3",
    USDT: "0x4557D5f50828302DB39D9530F6d3648d48bEC04A",
  },
};
